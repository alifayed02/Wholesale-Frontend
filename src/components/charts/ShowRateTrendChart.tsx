...
export interface ShowRateTrendDatum {
  date: string;
  rate: number;
}

interface ShowRateTrendChartProps {
  data: ShowRateTrendDatum[];
}

const ShowRateTrendChart: React.FC<ShowRateTrendChartProps> = ({ data }) => {
  return (
...
// Dummy usage
// <ShowRateTrendChart data={[
//   { date: "Jun 10", rate: 0.8 },
//   { date: "Jun 11", rate: 0.72 },
// ]} />

export default ShowRateTrendChart;
