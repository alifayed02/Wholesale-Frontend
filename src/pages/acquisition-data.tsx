...
const AcquisitionDataPage: React.FC = () => {
  ...
  useEffect(() => {
    if (rawData) {
      ...
      const calculatedKpis = calculateKpis(dataFiltered, dateRange, platform, coach, closer);
      setKpis(calculatedKpis);

      const funnelBreakdown = calculateFunnelBreakdown(dataFiltered, dateRange, platform, coach, closer);
      setFunnelData(funnelBreakdown);
    }
  }, [rawData, dateRange, platform, coach, closer, funnel]);
